...
const useStyles = makeStyles((colors) => ({
  ...
  heroTitle: { color: colors.white, fontWeight: "800", fontSize: 14, marginTop: 4 },
  progressCard: { padding: 18, marginBottom: spacing.md },
  progressRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  progressLabel: { color: colors.muted, fontSize: 10, fontWeight: "700", letterSpacing: 0.8, textTransform: "uppercase" },
  progressPct: { color: colors.primary, fontSize: 11, fontWeight: "800", textTransform: "uppercase" },
  tokenRow: { flexDirection: "row", alignItems: "baseline", marginTop: 10 },
  tokenNow: { color: colors.charcoal, fontSize: 22, fontWeight: "900" },
  tokenNeed: { color: colors.muted, fontSize: 12, fontWeight: "600" },
  ...
  gridLabel: { color: colors.muted, fontSize: 8, fontWeight: "700", textTransform: "uppercase" },
  gridValue: { color: colors.charcoal, fontSize: 10, fontWeight: "700", marginTop: 2 },
  terms: { marginTop: spacing.xl, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: spacing.lg },
  termsTitle: { color: colors.muted, fontSize: 9, fontWeight: "800", letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 8 },
  termsItem: { color: colors.slate, fontSize: 10, lineHeight: 16, marginBottom: 4 },
  buyBtn: {
