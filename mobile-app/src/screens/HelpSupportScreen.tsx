...
const useStyles = makeStyles((colors) => ({
  ...
  faqQ: { flex: 1, color: colors.charcoal, fontWeight: "600", fontSize: 15 },
  faqA: { color: colors.slate, fontSize: 13, lineHeight: 18, marginTop: 10 },
  action: {
  ...
  actionMeta: { flex: 1 },
  actionTitle: { color: colors.charcoal, fontWeight: "600", fontSize: 15 },
